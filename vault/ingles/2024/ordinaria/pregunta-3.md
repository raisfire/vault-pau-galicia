...
puntuacion: "5 puntos"
apartados:
  - "3.1. Write a new sentence that has the same meaning as the given one. You must use the word or expression in brackets. (2 points) a. There are fewer teachers in my school than there were last year. (many) b. If you work hard now, you won’t have to do so much later. (harder) c. Computers are much cheaper than they were a few years ago. (used) d. Why haven't they told people about the accident? (bee"
  - "3.2. Pronunciation. (0.5 points) a. In which word are the letters \"ea\" pronounced the same as in “bear”? lead, meal, pear, fear. b. Which of the following words has the same vowel sound as the vowel in “church”? cute, bench, third, park. c. Write a homophone (a word that sounds the same as another one but is spelled differently) for each of these words: “wood”, “weather”. d. In which word is the p"
  - "3.3. Write a composition answering this question: (2.5 points) Do you think there could be a connection between AI and unemployment in the future? (Approximately 120 words)"
ley_educativa: LOMCE
