...
batch_id = open("script/classify_tecnoloxia_batch_id.txt").read().strip()
targets = {t["custom_id"]: t for t in json.load(open("script/classify_tecnoloxia_targets.json", encoding="utf-8"))}
