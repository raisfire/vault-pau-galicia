...
vault/galego/ y script/stats_galego_2010_2019.json que violan el enum
estricto (mismo patron visto en Historia da Filosofia y Castelan).
...
from galego_temas import TEMAS_GALEGO

canon = set(TEMAS_GALEGO)
canon_lower = {t.lower(): t for t in TEMAS_GALEGO}
...
def fix_vault():
    fixed_files = 0
    for path in glob.glob("vault/galego/*/*/*.md"):
...
def fix_stats():
    path = "script/stats_galego_2010_2019.json"
