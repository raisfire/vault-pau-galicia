...
batch_id = open("script/classify_galego_batch_id.txt").read().strip()
targets = {t["custom_id"]: t for t in json.load(open("script/classify_galego_targets.json", encoding="utf-8"))}
