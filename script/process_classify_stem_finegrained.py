# -*- coding: utf-8 -*-
"""Aplica los resultados de los 3 batches de classify_stem_finegrained.py
a vault/{bioloxia,fisica,quimica}/*.md (tema: [] -> tema: [...])."""
import json
import os
import re
...
all_targets = json.load(open("script/classify_stem_finegrained_targets.json", encoding="utf-8"))
batch_ids = json.load(open("script/classify_stem_finegrained_batch_ids.json", encoding="utf-8"))
