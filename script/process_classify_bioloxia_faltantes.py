...
vault/bioloxia/*.md que tenian tema: [] (tema: [] -> tema: [...])."""
import json
import os
import re
...
batch_id = open("script/classify_bioloxia_faltantes_batch_id.txt").read().strip()
targets = {t["custom_id"]: t for t in json.load(open("script/classify_bioloxia_faltantes_targets.json", encoding="utf-8"))}
