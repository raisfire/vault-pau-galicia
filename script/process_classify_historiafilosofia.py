...
vault/historiafilosofia/*.md (tema: [] -> tema: [...])."""
import json
import os
import re
...
batch_id = open("script/classify_historiafilosofia_batch_id.txt").read().strip()
targets = {t["custom_id"]: t for t in json.load(open("script/classify_historiafilosofia_targets.json", encoding="utf-8"))}
