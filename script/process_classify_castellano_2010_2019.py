# -*- coding: utf-8 -*-
"""Procesa el batch de clasificacion de Lingua Castelá e Literatura II
2010-2019 y produce script/stats_castellano_2010_2019.json (mismo
esquema que stats_2010_2019.json)."""
import json
import os
...
batch_id = open("script/classify_castellano_2010_2019_batch_id.txt").read().strip()
targets = {t["custom_id"]: t for t in json.load(open("script/classify_castellano_2010_2019_targets.json", encoding="utf-8"))}
...
with open("script/stats_castellano_2010_2019.json", "w", encoding="utf-8") as f:
